...
3. **Clean** — Handle nulls and duplicates, standardise airport and route codes, correct data types.
...
![Passenger Recovery Index](images/PassengersRecoveryIndex.png)
...
![Passenger Traffic drop per Period](images/PassengersDrop2020.png)
...
### Dashboard 1 — Cargo/Passengers Geography
*Owner: Hendrik Albrecht/Natalia Ströher*
...
![Dashboard 1 — Cargo Geography](images/Geography.png)
...
![Dashboard 3 — Cargo per Flight Trend](images/cargo_efficiency_analysis.png)

---

### Dashboard 4 — Passenger Traffic per Airport
...
![Dashboard 5 — Growth by Region](images/GrowthPerRegion.png)

---

### Dashboard 6 — Conclusions
*Owner: both*
...
| NumPy / SciPy / Matplotlib 🗺️| Statistical tests (Shapiro-Wilk, Mann-Whitney U) |
...
To explore the analysis without running the pipeline, the `images/` folder contains screenshots of all dashboards and key matplotlib plots from the notebooks.
...
Data provided by **Eurostat** (https://ec.europa.eu/eurostat/de/data#), the statistical office of the European Union.
